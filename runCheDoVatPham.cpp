...
nhanvat bia[5]{
nhanvat(gALL,"data/bianho.png",1850,0),
nhanvat(gALL,"data/bianho.png",1850,0),
nhanvat(gALL,"data/bianho.png",1850,0),
nhanvat(gALL,"data/bianho.png",1850,0),
nhanvat(gALL,"data/bianho.png",1850,0)
...
int runCheDoVatPham(std::string name)
{
    ...
    khungXYWHbom[1].h=90;
    khungXYWHbom[2].w=99;
    khungXYWHbom[2].h=82;////82
    khungXYWHbom[3].w=83;
    khungXYWHbom[3].h=83;
    khungXYWHbom[4].w=65;
    khungXYWHbom[4].h=70;//30
...
bool init(){
    ...
    musicVatpham = Mix_LoadMUS("data/nhacnendotoc.mp3");
...
void vaTram(){
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        {
            khungXYWHbom[i].y=bom[i].returnToaDoY()+30;
        }
        else{
